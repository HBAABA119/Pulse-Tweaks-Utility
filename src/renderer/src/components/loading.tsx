...
//       >
//         <motion.div
//           className="text-2xl font-medium mb-8 text-void-text"
...
//         <div className="w-64 h-1 bg-void-accent rounded-full ">
//           <motion.div
//             className="h-full bg-void-primary"
...
//             <motion.div
//               key={i}
//               className={`w-3 h-3 rounded-full ${i === loadingStep ? "bg-void-primary" : "bg-void-accent"}`}
//               animate={{
