...
const Tooltip = ({
  ...
  return (
    ...
    >
      {children}
      <div
        className={`absolute z-50 pointer-events-none px-2 py-1 text-xs font-medium bg-void-card text-void-text rounded-md shadow-lg border border-void-border whitespace-nowrap transition-all duration-150 ease-out`}
        style={{
