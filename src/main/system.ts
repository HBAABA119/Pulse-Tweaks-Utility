...
function Show-InstallerGUI {
    ...
    $form.Text = "Void Optimizer: Winget Installer"
    ...
    [void]$powershell.AddScript({
        ...
        try {
            ...
            if ($TestMode -or -not $wingetInstalled) {
                ...
                $result.Messages += "Winget is already installed. Void Optimizer is ready to install apps!"
                $result.Success = $true
            }
        } catch {
...
ipcMain.handle("clear-void-cache", clearVoidOptimizerCache)
